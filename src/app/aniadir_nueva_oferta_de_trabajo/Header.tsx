  ...
  return (
    <header className="flex justify-between items-center px-10 py-3 border-b border-gray-200">
        ...
        <nav className="flex gap-9 text-sm font-medium text-gray-900">
          <Link href="#" className="hover:text-blue-600">Encontrar Fixers</Link>
          <Link href="#" className="hover:text-blue-600">Fixer</Link>
          <Link href="#" className="hover:text-blue-600">Mis Ofertas</Link>
          <Link href="#" className="hover:text-blue-600">Ayuda</Link>
        </nav>
      </header>
  );
}