...
// Ventana flotante + provider
import { QuickRecipientsProvider } from "@/components/quick-recipients/NotificationsContext";
import QuickRecipientsFloating from "@/components/quick-recipients/QuickRecipientsFloating";
...
export default function Home() {
  ...
  return (
    // ✅ Envolvemos toda la página con el Provider para que el modal y la ventana flotante compartan el contexto
    <QuickRecipientsProvider>
      <div className="min-h-screen flex flex-col bg-gray-100 text-gray-900 relative">
        ...
        {/* ✅ Ventana flotante fija, no interfiere con el layout */}
        <QuickRecipientsFloating />
      </div>
    </QuickRecipientsProvider>
  );
}
