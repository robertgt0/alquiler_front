...
const C = {
  title: '#0C4FE9',
  text: '#1140BC',
  borderMain: '#0C4FE9', // Azul original (se mantiene la variable pero no se usa en el borde)
  confirmed: '#1366FD',
  pending: '#F0D92B',
  cancelled: '#E84141',
  white: '#FFFFFF',
...
export default function DetalleCanceladoCliente({ data }: { data: SolicitudClienteDetalle }) {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 680, margin: '0 auto' }}>
      ...
      {/* Borde blanco (C.white) para que no se vea el recuadro azul */}
      <section style={{ border: `2.5px solid ${C.white}`, borderRadius: 10, background: C.white, padding: '18px 20px', color: '#111', fontSize: 18, lineHeight: '28px' }}>
        ...
        {/* ✅ CAMBIO 1: Solo mostramos Cliente (Proveedor eliminado para limpiar la vista) */}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, margin: '8px 0' }}>
          ...
          {/* ✅ CAMBIO 2: Quitamos el texto fijo "Cancelado por" para evitar duplicados */}
          {esCancelado && (
