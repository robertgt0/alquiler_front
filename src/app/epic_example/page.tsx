...
export default function Home() {
  ...
  const proveedores = [
    ...
    { id: 3, nombreServicio: "Clases de Yoga", especialista: "Ana Gómez", descripcion: "Sesiones de yoga personalizadas para mejorar flexibilidad y bienestar mental.", precio: 40, rating: 4.8 },
