...
export const HomeHammerIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 h-16 text-gray-400 transition-transform duration-300 ease-in-out group-hover:scale-110">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 21V10.5c0-1.242 1.008-2.25 2.25-2.25h1.5c1.242 0 2.25 1.008 2.25 2.25V21m-9 0h9M6 21H3.75v-6H6v6zM18 21h2.25v-6H18v6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12l-6-6M12 15l-3-3" strokeWidth={2.5} />
    </svg>
);
export const SearchIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-gray-400 transition-transform duration-300 ease-in-out group-hover:scale-110">
...
export const BriefcaseIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-gray-400 transition-transform duration-300 ease-in-out group-hover:scale-110">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.863 2.386-1.925 2.386H5.675c-1.062 0-1.925-1.073-1.925-2.386V14.15M18 18.235v-4.075c0-1.313-.863-2.386-1.925-2.386H7.925c-1.062 0-1.925 1.073-1.925 2.386v4.075M10.125 11.96v-1.63c0-1.313.863-2.386 1.925-2.386h0c1.062 0 1.925 1.073 1.925 2.386v1.63" />
    </svg>
);