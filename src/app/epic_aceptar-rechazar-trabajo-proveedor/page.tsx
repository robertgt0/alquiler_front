...
import {
  EstadoTrabajo,
  SolicitudDetalle,
} from "./interfaces/Trabajo.interface";

export const dynamic = "force-dynamic";

/** Valida un estado recibido por query contra el union type */
function parseEstado(value: string | null): EstadoTrabajo {
  const valid: EstadoTrabajo[] = [
    "Pendiente",
    "Confirmado",
    "Cancelado",
    "Terminado",
  ];
  if (value && (valid as string[]).includes(value)) return value as EstadoTrabajo;
  return "Pendiente";
}

/** Construye el detalle desde los query params (fallbacks incluidos) */
...
export default function Page() {
  ...
  // Fallback demo si entran sin params
